/**
 * @file IconsMaterialDesign.h
 * @author B.G. Smit
 * @brief Defines Material Design icons for use with Dear ImGui.
 *
 * This file is typically generated and contains Unicode codepoints and string representations
 * for various Material Design icons, allowing them to be easily integrated into the UI.
 * @copyright Copyright (c) 2025
 */
// Generated by https://github.com/juliettef/IconFontCppHeaders script GenerateIconFontCppHeaders.py
// // for C and C++ // from codepoints
